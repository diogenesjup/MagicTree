...
var urlCnd         = "https://baltimoreeducation.com.br/admin/arquivos/";
...
function carregarTrack(idTrack){
  ...
  // DESLIGAR O PLAYER FLUTUANTE
  fecharPlayerAudioLivros2();
...
// DEIXAR A PÁGINA FULLSCREEEN
var elem = document.documentElement;
var controleFullScreen = 9;

/* View in fullscreen */
function openFullscreen() {

/*
 if(controleFullScreen==9){
      ...
      controleFullScreen=9; 
 }
*/

 if(controleFullScreen==9){
  //$(".livros-fullscreen").fadeIn("500");
  controleFullScreen=1;
  $(".container.caixa-conteudo").addClass("the-new-fullscreen");
 }else{
  //$(".livros-fullscreen").fadeOut("500");
  controleFullScreen=9; 
  $(".container.caixa-conteudo").removeClass("the-new-fullscreen");
 }
...
function aplicarZoom(){
   ...
   if(zoomVm==9){
     $(".caixa-conteudo").css("transform","scale(1.15)");
     zoomVm = 1;
   }else{
    $(".caixa-conteudo").css("transform","scale(1)"); 
    zoomVm=9;
   }
 ...
 */
    function renderPL() {
      ...
      pl = create('div', {
        ...
        'id': 'pl',
        'innerHTML': '<ul class="pl-ul">' + (!isEmptyList() ? html.join('') : '<li class="pl-list--empty">PlayList está vazia</li>') + '</ul>'
      });
 ...
 */
  ...
  function clearAll() {
    audio.pause();
    audio.src = '';
    trackTitle.innerHTML = 'lista está vazia';
    curTime.innerHTML = '--';
    durTime.innerHTML = '--';
    progressBar.style.width = 0;
    preloadBar.style.width = 0;
    ...
    playSvgPath.setAttribute('d', playSvg.getAttribute('data-play'));
    if(!plUl.querySelector('.pl-list--empty')) {
      plUl.innerHTML = '<li class="pl-list--empty">PlayList está vazia</li>';
    }
    changeDocumentTitle();
  }
...
function iniciarPlayerAudiosLivros(listaPlayer){
   
   $("#ap").fadeIn("500");
   AP.init({
    playList:listaPlayer
  });
...
function fecharPlayerAudioLivros(){
    $("#ap").fadeOut("500");
    AP.destroy();
}

function fecharPlayerAudioLivros2(){
    $("#ap").fadeOut("1");
    AP.destroy();
...
var controleNovoZoom = 0;
var controleQuadro   = 0;
function novoZoom(){
  
                   var arraysOfIds = $('#aquiCarregamosImagens .item.active img').map(function(){
                       return this.src;
                   }).get();

                  console.log(arraysOfIds);

                  localStorage.setItem("coluna1",arraysOfIds[0]);
                  localStorage.setItem("coluna2",arraysOfIds[0]);
                  
                  if(controleNovoZoom==0){
                      $(".the-sinners").fadeIn("500");
                      controleNovoZoom=1;
                  }else{
                      $(".the-sinners").fadeOut("500");
                      controleNovoZoom=0;

                      $("body .the-sinners").css("background","rgba(255,255,255,0.70)");
                      $(".square").css("border","1px solid #0a7a8e");
                  }
}

function closeNovoZoom(){
    $(".the-sinners").fadeOut("500");
    controleNovoZoom=0;
...
function quadrante(quadro){

  console.log("ENTREI QUADRO");

  if(controleQuadro==0){

   if(quadro==1 && controleQuadro==0){
      console.log("QUADRO 1");
      $(".square").css("border","none");
      $("body .the-sinners").css("background","url('"+localStorage.getItem("coluna1")+"') no-repeat transparent");
      $("body .the-sinners").css("background-size","200% auto");
      $("body .the-sinners").css("background-position","left top");
   }
   if(quadro==2 && controleQuadro==0){
    console.log("QUADRO 2");
      $(".square").css("border","none");
      $("body .the-sinners").css("background","url('"+localStorage.getItem("coluna2")+"') no-repeat transparent");
      $("body .the-sinners").css("background-size","200% auto");
      $("body .the-sinners").css("background-position","right top");
    
   }
   if(quadro==3 && controleQuadro==0){
    console.log("QUADRO 3");
    $(".square").css("border","none");
      $("body .the-sinners").css("background","url('"+localStorage.getItem("coluna1")+"') no-repeat transparent");
      $("body .the-sinners").css("background-size","200% auto");
      $("body .the-sinners").css("background-position","left bottom");
    
   }
   if(quadro==4 && controleQuadro==0){
    console.log("QUADRO 4");
     $(".square").css("border","none");
      $("body .the-sinners").css("background","url('"+localStorage.getItem("coluna2")+"') no-repeat transparent");
      $("body .the-sinners").css("background-size","200% auto");
      $("body .the-sinners").css("background-position","right bottom");
