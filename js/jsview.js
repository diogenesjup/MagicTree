...
$JSView = {
    run: function(type){
        ...
        $v.select('.caixa-conteudo').innerHTML += spinnerModal;
    ...
    declareView: function(e){
        ...
        for(var obj in e){
            ...
            if(!$v.select('#' + obj)){
                ...
                $v.select('.caixa-conteudo').innerHTML += '<jsv-view id="' + obj + '"></jsv-view>';
    ...
    initView: function(e){
        ...
        window.history.pushState(e, "Titulo", paginaSessao+'#' + e);
    },
...
//       console.groupEnd();
  ...
  //    console.time("goToView");
    ...
    declareMenu: function(e){
        ...
        $v.select('.caixa-conteudo').innerHTML = '<jsv-main></jsv-main>';
    ...
    declareModal: function(e,options){
        ...
        for(var obj in e){
            ...
            if(!$v.select('#' + obj)){
                ...
                $v.select('.caixa-conteudo').innerHTML += '<jsv-modal id="' + obj + '"></jsv-modal>';
                //Put all containers out the camera
